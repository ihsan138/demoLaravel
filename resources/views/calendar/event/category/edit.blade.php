...
<div class="container-fluid">
    <div class="row"> <!-- use class:justify-content-center to center card content -->
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Update Category Event</div>
    
                <div class="card-body">
                    <form id="form" method="post" action="{{route('calendar.event.category.update', $result)}}" enctype="multipart/form-data"  autocomplete="off">
                        @csrf 
                        @method('PUT')
