...
<div class="container-fluid">
    <div class="row"> <!-- use class:justify-content-center to center card content -->
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Update Category Calibration</div>
    
                <div class="card-body">
                    <form id="form" method="post" action="{{route('calendar.calibration.category.update', $result)}}" enctype="multipart/form-data"  autocomplete="off">
                        @csrf 
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="borderColor" name="borderColor" value="{{ $result->borderColor }}" type="text" class="form-control">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="backgroundColor" name="backgroundColor" value="{{ $result->backgroundColor }}" type="text" class="form-control">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                </div>
