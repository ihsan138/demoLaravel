...
@section('adminlte_js')
    ...
    <!-- For autologout -->
    <script>
        /* define toastr sweetalert2 here */ 
        const toastr = Swal.mixin({                             //this cannot be moved to master layout due to const variable
            toast: true,                                        //always set true, to make small toast
        ...
        $(document).ready(function() {
            /* define idleTimeout here */ 
            $(document).idleTimeout({
                redirectUrl: '/inactivity',                                     // redirect to this url
                idleTimeLimit: 600,                                             // 15 seconds 'No activity' time limit in seconds.
        ...
        //by default, datalabels are defined globally. [chartjs-plugin-datalabels]
