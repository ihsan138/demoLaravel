    ...
    <div class="row"> <!-- use class:justify-content-center to center card content -->
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" method="post" action="{{route('roles.update', $result)}}" enctype="multipart/form-data"  autocomplete="off">
                        @csrf 
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select id="permission" name="permission[]" multiple="multiple" data-placeholder="Select a permission" class="form-control select2" style="width: 100%;">      
                                    <option></option>    
                                    @foreach ($permissions as $data)
                                        @if(in_array($data->name, $selected_permissions))
