        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <strong><i class="fas fa-book mr-1"></i> Guard name</strong>
                    <p class="text-muted">
                        {{$result->guard_name}}
                    </p>
                    <strong><i class="fas fa-book mr-1"></i> Permissions</strong>
                    <ol>
                    @foreach ($selected_permissions as $permissions)
                        <li>{{$permissions}}</li>
                    @endforeach
                    </ol>
                </div>
...
<!-- MODALS -->
<!-- SoftDelete Modals (Delete & Restore) -->
<div class="modal fade" id="modal-delete" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer justify-content-between">
            ...
            <form action="{{ route('roles.destroy',$result->id)}}" method="POST">
                @csrf 
...
<div class="modal fade" id="modal-restore" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <form action="{{ route('roles.restore',$result->id)}}" method="GET">
                @csrf 
