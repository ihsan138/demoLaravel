...
<div class="container-fluid">
    <div class="row"> <!-- use class:justify-content-center to center card content -->
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Create Template Basic</div>
    
                <div class="card-body">
                    <form id="form" method="post" action="{{route('template.basic.store')}}" enctype="multipart/form-data"  autocomplete="off">
                        @csrf 
