    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route('template.basic.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> Create</a>
                </div>
                <!--
...
function myFunction(type){
    ...
    $('#datatable')
        ...
        ajax:{
            url: "/template/basic/getDatatable/"+type,              //get data from controller, init
