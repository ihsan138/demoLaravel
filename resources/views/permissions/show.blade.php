...
<div class="container-fluid">
    ...
    <div class="row"> <!-- use class:justify-content-center to center card content -->
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Permissions Information</div>
...
<div class="modal fade" id="modal-delete" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer justify-content-between">
            ...
            <form action="{{ route('permissions.destroy',$result->id)}}" method="POST">
                @csrf 
...
<div class="modal fade" id="modal-restore" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <form action="{{ route('permissions.restore',$result->id)}}" method="GET">
                @csrf 
