...
class CreateCalendarCalibrationCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calendar_calibration_category', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('calendar_calibration_category');
    }
}
