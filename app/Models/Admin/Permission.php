...
class Permission extends Model
{
     ...
     */
    public static $rules = [
        'name' => 'required|min:5|alpha_spaces|unique:permissions,name',       //alpha_spaces is a custom validation, defined in AppServiceProvider.php as alpha regex in standard Laravel does not accept spaces.
    ];
