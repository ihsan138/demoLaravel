...
class Department extends Model
{
     ...
     */
    public static $rules = [
        'name' => 'required|min:5|alpha_spaces|unique:company_department,name',         //alpha_spaces is a custom validation, defined in AppServiceProvider.php as alpha regex in standard Laravel does not accept spaces.
    ];
