...
class Calendar extends Model
{
     ...
     * Override table
     */
    protected $table = 'calendar_calibration'; 
     ...
     */
    protected $fillable = [
       'calendar_calibration_category_id', 'title', 'rrule',
    ];
    ...
    public function category(){
        return $this->belongsTo('App\Models\Calendar\Calibration\Category','calendar_calibration_category_id','id');
    }
