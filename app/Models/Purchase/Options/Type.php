...
class Type extends Model
{
     ...
     * Override table
     */
    protected $table = 'purchase_options_type'; 
     ...
     */
    public static $rules = [
        'name' => 'required|min:5|alpha_spaces|unique:purchase_options_type,name',         //alpha_spaces is a custom validation, defined in AppServiceProvider.php as alpha regex in standard Laravel does not accept spaces.
    ];
