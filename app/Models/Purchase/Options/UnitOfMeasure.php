...
class UnitOfMeasure extends Model
{
     ...
     * Override table
     */
    protected $table = 'purchase_options_unit_of_measure'; 
     ...
     */
    public static $rules = [
        'name' => 'required|min:3|alpha_spaces|unique:purchase_options_unit_of_measure,name',         //alpha_spaces is a custom validation, defined in AppServiceProvider.php as alpha regex in standard Laravel does not accept spaces.
    ];
