...
class ApproveReject extends Model
{
     ...
     * Override table
     */
    protected $table = 'options_approve_reject'; 
     ...
     */
    public static $rules = [
        'name' => 'required|min:5|alpha_spaces|unique:options_approve_reject,name',         //alpha_spaces is a custom validation, defined in AppServiceProvider.php as alpha regex in standard Laravel does not accept spaces.
    ];
