...
class ActiveInactive extends Model
{
     ...
     * Override table
     */
    protected $table = 'options_active_inactive'; 
     ...
     */
    public static $rules = [
        'name' => 'required|min:5|alpha_spaces|unique:options_active_inactive,name',         //alpha_spaces is a custom validation, defined in AppServiceProvider.php as alpha regex in standard Laravel does not accept spaces.
    ];
